...
class LineBasedCorporaBatchBuilder(object):
    ...
    def __init__(self, corpora_file_list, output_dir,
        ...
        self.line_processor = ContextWindowBasedLineProcessor(skip_window=skip_window, record_delimiter=record_delimiter)
    ...
    def _build_worker(self, corpora_file):
        ...
        print(output_file)
        corpora = LineBasedCorporaBuilder(corpora_file,
                                          self.line_processor,
                                          self.data_exporter)
