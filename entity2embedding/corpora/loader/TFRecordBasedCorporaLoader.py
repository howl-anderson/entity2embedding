...
class TFRecordBasedCorporaLoader(DatasetBasedCorporaLoader):
    def __init__(self, corpora_file_list, metadata_file, window_based_metadata_file):
        ...
        super(TFRecordBasedCorporaLoader, self).__init__(corpora_file_list, metadata_file, window_based_metadata_file, dataset_loader, record_parser, metadata_loader)
